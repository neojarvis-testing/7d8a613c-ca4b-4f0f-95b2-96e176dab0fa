...
export class ProducteditService {
  ...
  constructor(private http: HttpClient) {
    this.apiUrl = 'https://8080-ffdcbfcaefecfbebadeeffdabedffcafacb.ide.exam.ly/admin/productEdit/';
  ...
  setid(data:any){
    this.productId = data;
    this.apiUrl = 'https://8080-ffdcbfcaefecfbebadeeffdabedffcafacb.ide.exam.ly/admin/productEdit/'+this.productId;
  }
